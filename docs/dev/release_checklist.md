...
Draft a [new release](ssh://git.j-fuchs.at:/volume1/gitlab/net-automation/nautobot-app-livedata.git/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in ssh://git.j-fuchs.at:/volume1/gitlab/net-automation/nautobot-app-livedata.git/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: ssh://git.j-fuchs.at:/volume1/gitlab/net-automation/nautobot-app-livedata.git/compare/v1.4.1...v1.4.2
```
